...
<!-- Mirrored from htmldesigntemplates.com/html/ayurvedic/dashboard-add-new.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2026 08:57:51 GMT -->
<head>
    <meta charset="UTF-8" />
        ...
        <div class="container">
          <div class="top-info d-flex justify-content-between align-items-center">
            <ul class="t-address">
              ...
              <li><i class="far fa-envelope"></i> <a href="https://htmldesigntemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1970777f76597c69786d716a787578377a7674">[email&#160;protected]</a></li>
            </ul>
            <ul class="t-social">
              <li>
                  ...
                  <div class="listing-main">
                    <div class="addlist-inner mb-3">
                      ...
                      <div class="addlist-content bg-white">
                        <form action="https://htmldesigntemplates.com/">
                          <div class="row">
                      ...
                      <div class="addlist-content bg-white">
                        <form action="https://htmldesigntemplates.com/">
                          <div class="row">
                                ...
                                <div class="row align-items-center">
                                  ...
                                  <div class="col-lg-2 col-md-2 col-xs-12">
                                    <div class="listing-btn d-flex justify-content-between align-items-center text-right">
                                      <a href="#" class="btn btn-na"><i class="fa fa-times"></i></a>
                                      <a href="#" class="btn btn-na btn-blue"><i class="fa fa-expand-arrows-alt"></i></a>
                                    </div>
                                  </div>
                                </div>
                              </div>
                            ...
                            <div class="col-lg-12">
                              <a href="#" class="btn btn-na"><i class="fa fa-plus"></i> Add New</a>
                            </div>
                          </div>
                        </form>
                      </div>
                              ...
                              <div class="form-group m-0">
                                <div class="row d-flex align-items-center">
                                  ...
                                  <div class="col-lg-4 col-md-2 col-xs-12">
                                    <div class="listing-btn d-flex justify-content-between align-items-center text-right">
                                      <a href="#" class="btn btn-na mr-2"><i class="fa fa-times"></i></a>
                                      <a href="#" class="btn btn-na btn-blue"><i class="fa fa-expand-arrows-alt"></i></a>
                                      <a href="#" class="btn btn-na"><i class="fa fa-plus"></i> Add New</a>
                                    </div>
                                  </div>
                    ...
                    <a href="#" class="btn btn-na">Submit Listing</a>
                  </div>
                </div>
              </div>
            </div>
