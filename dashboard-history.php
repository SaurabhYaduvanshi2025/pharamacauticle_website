...
<!-- Mirrored from htmldesigntemplates.com/html/ayurvedic/dashboard-history.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2026 08:57:50 GMT -->
<head>
    <meta charset="UTF-8" />
        ...
        <div class="container">
          <div class="top-info d-flex justify-content-between align-items-center">
            <ul class="t-address">
              ...
              <li><i class="far fa-envelope"></i> <a href="https://htmldesigntemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="caa3a4aca58aafbaabbea2b9aba6abe4a9a5a7">[email&#160;protected]</a></li>
            </ul>
            <ul class="t-social">
              <li>
                    ...
                    <table class="basic-table history-table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-na dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-na dropdown-toggle" type="button" id="dropdownMenuButton2" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="fa fa-plus"></span>
                              </button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Send Email</a>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-na dropdown-toggle" type="button" id="dropdownMenuButton3" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="fa fa-plus"></span>
                              </button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Send Email</a>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-na dropdown-toggle" type="button" id="dropdownMenuButton4" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="fa fa-plus"></span>
                              </button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Send Email</a>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-na dropdown-toggle" type="button" id="dropdownMenuButton5" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="fa fa-plus"></span>
                              </button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Send Email</a>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-na dropdown-toggle" type="button" id="dropdownMenuButton6" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="fa fa-plus"></span>
                              </button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Send Email</a>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-na dropdown-toggle" type="button" id="dropdownMenuButton7" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="fa fa-plus"></span>
                              </button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Send Email</a>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-na dropdown-toggle" type="button" id="dropdownMenuButton8" data-bs-toggle="dropdown" aria-expanded="false">
                                <span class="fa fa-plus"></span>
                              </button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="#">Send Email</a>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a0a7a4c9a8a544a3',t:'MTc4MTI1NDYwMQ=='};var a=document.createElement('script');a.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/8fc8ed1d8752/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
