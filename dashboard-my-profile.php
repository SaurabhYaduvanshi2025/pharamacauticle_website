...
<!-- Mirrored from htmldesigntemplates.com/html/ayurvedic/dashboard-my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2026 08:57:47 GMT -->
<head>
    <meta charset="UTF-8" />
        ...
        <div class="container">
          <div class="top-info d-flex justify-content-between align-items-center">
            <ul class="t-address">
              ...
              <li><i class="far fa-envelope"></i> <a href="https://htmldesigntemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="3d54535b527d584d5c49554e5c515c135e5250">[email&#160;protected]</a></li>
            </ul>
            <ul class="t-social">
              <li>
                      ...
                      <div class="dashboard-list">
                        ...
                        <div class="dashboard-list-static">
                          ...
                          <div class="edit-profile-photo">
                            <img src="images/inner/user-avatar.jpg" alt="" />
...
Maecenas quis consequat libero, a feugiat eros. Nunc ut lacinia tortor morbi ultricies laoreet ullamcorper phasellus semper</textarea
                              >
                            </div>
                          ...
                          <div>
                            <a href="#" class="btn btn-na">SAVE CHANGE</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <form>
                      <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                          <div class="form-group currency-content">
                        ...
                        <div class="col-lg-12">
                          <div class="currency-content">
                            <p class="bold mb-1">Send Enrique Mail</p>
                            <div class="pretty p-default p-thick p-pulse">
                              <input type="checkbox" />
                              <div class="state d-flex align-items-center p-warning-o">
                                <label>Admin & Customer</label>
                              </div>
                            </div>
                            <div class="pretty p-default p-thick p-pulse">
                              <input type="checkbox" />
                            ...
                            <div class="pretty p-default p-thick p-pulse">
                              <input type="checkbox" />
                              <div class="state d-flex align-items-center p-warning-o">
                                <label>Admin, Partner & Customer</label>
                              </div>
                            </div>
                          </div>
                        </div>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a0a7a4a4d9445d5e',t:'MTc4MTI1NDU5NQ=='};var a=document.createElement('script');a.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/8fc8ed1d8752/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>

<!-- Mirrored from htmldesigntemplates.com/html/ayurvedic/dashboard-my-profile.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2026 08:57:48 GMT -->
</html>
