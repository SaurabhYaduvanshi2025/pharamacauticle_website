...
<!-- Mirrored from htmldesigntemplates.com/html/ayurvedic/dashboard-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2026 08:57:51 GMT -->
<head>
    <meta charset="UTF-8" />
        ...
        <div class="container">
          <div class="top-info d-flex justify-content-between align-items-center">
            <ul class="t-address">
              ...
              <li><i class="far fa-envelope"></i> <a href="https://htmldesigntemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="6e070008012e0b1e0f1a061d0f020f400d0103">[email&#160;protected]</a></li>
            </ul>
            <ul class="t-social">
              <li>
              ...
              <div class="dashboard-content">
                <div class="dashboard-review single-comments">
                  <div class="comments">
                    <div class="comment-box d-flex align-items-center justify-content-between">
                      ...
                      <div class="comment-content">
                        ...
                        <p class="comment mt-2">
                          Take in the iconic skyline and visit the neighbourhood hangouts that you've only ever seen on TV. Take in the iconic skyline and visit
                          the neighbourhood.
                        </p>
                      </div>
                    </div>
                    ...
                    <div class="comment-box d-flex align-items-center justify-content-between">
                      <div class="comment-image">
                        <img src="images/team/user-4.jpg" alt="image" />
                      </div>
                      <div class="comment-content">
                        <h5 class="m-0">Helena</h5>
                        <p class="comment-date mb-2">April 25, 2019 at 10:46 am</p>
                    ...
                    <div class="comment-box d-flex align-items-center justify-content-between">
                      <div class="comment-image">
                        <img src="images/team/user-3.jpg" alt="image" />
                      </div>
                      <div class="comment-content">
                        <h5 class="m-0">Helena</h5>
                        <p class="comment-date mb-2">April 25, 2019 at 10:46 am</p>
...
<script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a0a7a4ec2b9444a3',t:'MTc4MTI1NDYwNg=='};var a=document.createElement('script');a.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/8fc8ed1d8752/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script></body>
