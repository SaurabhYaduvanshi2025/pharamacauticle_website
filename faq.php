...
<!-- Mirrored from htmldesigntemplates.com/html/ayurvedic/faq.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2026 08:57:35 GMT -->
<head>
    <meta charset="UTF-8" />
  ...
  <body>
        ...
        <div class="container">
          <div class="top-info d-flex justify-content-between align-items-center">
            <ul class="t-address">
              ...
              <li><i class="far fa-envelope"></i> <a href="https://htmldesigntemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="177e79717857726776637f64767b763974787a">[email&#160;protected]</a></li>
            </ul>
            <ul class="t-social">
              <li>
    ...
    <section class="faq-1">
      <div class="container">
        <div class="sc-title-two text-center">
          <h4 class="cl-green">Questions</h4>
          <h2>Do You Have Any Questions?</h2>
        </div>
        <div class="row align-items-center">
          <div class="col-lg-8 col-md-12 pe-lg-5">
            <div class="faq-content sv-detail-content">
              <div class="accordion mt-4" id="accordionExample">
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingOne">
                    <button
                      class="accordion-button bg-sfgrey-3 fw-bold"
                      type="button"
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="headingTwo">
                    <button
                      class="accordion-button bg-sfgrey-3 fw-bold collapsed"
                      type="button"
                      data-bs-toggle="collapse"
                ...
                <div class="accordion-item">
                  <h2 class="accordion-header" id="heading4">
                    ...
                    >
                      How long dose take my check-up test?
                    </button>
                  </h2>
          ...
          <div class="col-lg-4 col-md-12">
            <img src="images/banner/Thank-You-Paramedic-Graphic-01-01.png" alt="" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-12 pe-lg-5">
            <div class="checkup-img">
              <img src="images/home/pediatrician-examining-boy-s-spine-2021-04-02-20-48-30-utc.jpg" alt="" />
            </div>
          </div>
          <div class="col-lg-6 col-md-12">
            <div class="faq-content-2 sv-detail-content">
              <div class="accordion mt-4" id="accordionExample2">
                <div class="accordion-item">
                  ...
                  <div id="collapse7" class="accordion-collapse collapse show" aria-labelledby="heading7" data-bs-parent="#accordionExample2">
                    <div class="accordion-body">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit. Non fugiat blanditiis vel voluptatum reiciendis, exercitationem facilis magni
                      corporis, ullam odit explicabo quas a voluptatem ipsam, iusto sapiente officiis esse consectetur!
                    </div>
    ...
    <!-- Appointment start -->
    <section class="appointment faq-pg bg-sfgrey-2 pb-10">
      <div class="container">
        <div>
          <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
              <div class="appoint-form">
                <form class="row g-3">
                  ...
                  <div class="col-md-12">
                    <input type="text" class="form-control" placeholder="Enter Subject" aria-label="Enter Your Subject" />
                  </div>
                  <div class="col-12">
            ...
            <div class="col-lg-6 col-md-12 ps-lg-5">
              <div class="sc-title-two sc-border-left sc-border-none appoint-info w-100 mb-xs-0">
                ...
                <h2 class="mt-2">Do You Have Any Questions?</h2>
