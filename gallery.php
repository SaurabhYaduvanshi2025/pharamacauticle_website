...
<!-- Mirrored from htmldesigntemplates.com/html/ayurvedic/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2026 08:57:23 GMT -->
<head>
    <meta charset="UTF-8" />
  ...
  <body>
        ...
        <div class="container">
          <div class="top-info d-flex justify-content-between align-items-center">
            <ul class="t-address">
              ...
              <li><i class="far fa-envelope"></i> <a href="https://htmldesigntemplates.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="cda4a3aba28da8bdacb9a5beaca1ace3aea2a0">[email&#160;protected]</a></li>
            </ul>
            <ul class="t-social">
              <li>
    ...
    <section class="breadcrumb-wrap">
      <div class="container">
        <h2 class="cl-white mb-0">Gallery</h2>
      </div>
    ...
    <div class="gallery pt-14 pb-14">
      <div class="container">
        <div id="macy-container">
          <div class="demo">
            <a href="images/lightbox/doctor-and-medical-assistants-discussing-about-dia-CRXDCB6.jpg" data-lightbox="gallery">
              <img src="images/lightbox/doctor-and-medical-assistants-discussing-about-dia-CRXDCB6.jpg" alt="" class="demo-image wow fadeInUp" />
            </a>
          </div>
          <div class="demo">
            <a href="images/lightbox/female-medical-worker-2021-04-03-03-56-15-utc.jpg" data-lightbox="gallery">
              <img src="images/lightbox/female-medical-worker-2021-04-03-03-56-15-utc.jpg" alt="" class="demo-image wow fadeInUp" />
            </a>
          </div>
          <div class="demo">
            <a href="images/lightbox/medical-2021-06-09-20-49-41-utc.jpg" data-lightbox="gallery">
              <img src="images/lightbox/medical-2021-06-09-20-49-41-utc.jpg" alt="" class="demo-image wow fadeInUp" />
            </a>
          </div>
          <div class="demo">
            <a href="images/lightbox/medical-nurse-worker-examining-a-medical-report-2021-04-03-23-54-24-utc.jpg" data-lightbox="gallery">
              <img src="images/lightbox/medical-nurse-worker-examining-a-medical-report-2021-04-03-23-54-24-utc.jpg" alt="" class="demo-image wow fadeInUp"
            /></a>
          </div>
          <div class="demo">
            <a href="images/lightbox/medical-experts-2021-05-02-19-42-45-utc.jpg" data-lightbox="gallery">
              <img src="images/lightbox/medical-experts-2021-05-02-19-42-45-utc.jpg" alt="" class="demo-image wow fadeInUp"
            /></a>
          </div>
          <div class="demo">
            <a href="images/lightbox/medical-prescriptions-HU963N2.jpg" data-lightbox="gallery">
              <img src="images/lightbox/medical-prescriptions-HU963N2.jpg" alt="" class="demo-image wow fadeInUp"
            /></a>
          </div>
          <div class="demo">
            <a href="images/lightbox/teenage-boy-having-medical-consultation-with-docto-SKLQAWP.jpg" data-lightbox="gallery">
              <img src="images/lightbox/teenage-boy-having-medical-consultation-with-docto-SKLQAWP.jpg" alt="" class="demo-image wow fadeInUp"
            /></a>
          </div>
          <div class="demo">
            <a href="images/lightbox/medical-team-workers-examining-a-medical-report-KQ5AY7L.jpg" data-lightbox="gallery">
              <img src="images/lightbox/medical-team-workers-examining-a-medical-report-KQ5AY7L.jpg" alt="" class="demo-image wow fadeInUp"
            /></a>
          </div>
        </div>
      </div>
    ...
    <section class="emergency-call pb-0">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-6">
            <div class="sc-title-two sc-title-two-white appoint-info text-center w-100 mb-7">
            ...
            <div class="appoint-detail text-center">
    ...
    <section class="partners bg-sfgrey p-5">
      <div class="container">
        <div class="row align-items-center">
          <div class="col-lg-3">
            <h3 class="m-0">Our Affiliations</h3>
          </div>
          <div class="col-lg-9">
            <div class="partner-slider">
              ...
              <div class="partner-list p-2">
                <img src="images/partners/logo6.png" alt="" />
              </div>
              <div class="partner-list p-2">
                <img src="images/partners/logo4.png" alt="" />
              </div>
  ...
  <script>(function(){function c(){var b=a.contentDocument||a.contentWindow.document;if(b){var d=b.createElement('script');d.innerHTML="window.__CF$cv$params={r:'a0a7a4559e3844a3',t:'MTc4MTI1NDU4Mg=='};var a=document.createElement('script');a.src='../../cdn-cgi/challenge-platform/h/g/scripts/jsd/8fc8ed1d8752/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";b.getElementsByTagName('head')[0].appendChild(d)}}if(document.body){var a=document.createElement('iframe');a.height=1;a.width=1;a.style.position='absolute';a.style.top=0;a.style.left=0;a.style.border='none';a.style.visibility='hidden';document.body.appendChild(a);if('loading'!==document.readyState)c();else if(window.addEventListener)document.addEventListener('DOMContentLoaded',c);else{var e=document.onreadystatechange||function(){};document.onreadystatechange=function(b){e(b);'loading'!==document.readyState&&(document.onreadystatechange=e,c())}}}})();</script><script defer src="https://static.cloudflareinsights.com/beacon.min.js/v833ccba57c9e4d2798f2e76cebdd09a11778172276447" integrity="sha512-57MDmcccJXYtNnH+ZiBwzC4jb2rvgVCEokYN+L/nLlmO8rfYT/gIpW2A569iJ/3b+0UEasghjuZH/ma3wIs/EQ==" data-cf-beacon='{"version":"2024.11.0","token":"e2e296138d64407b8469055f5cbf0b42","r":1,"server_timing":{"name":{"cfCacheStatus":true,"cfEdge":true,"cfExtPri":true,"cfL4":true,"cfOrigin":true,"cfSpeedBrain":true},"location_startswith":null}}' crossorigin="anonymous"></script>
</body>

<!-- Mirrored from htmldesigntemplates.com/html/ayurvedic/gallery.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 12 Jun 2026 08:57:35 GMT -->
</html>
